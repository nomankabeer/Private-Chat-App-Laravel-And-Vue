    ...
    <ul class="over-flow-y-scroll list scroll-style-1">
        <li class="clearfix" v-for="user,index in users">
            ...
            <div class="about">
                ...
                <div class="status">
                   <span v-if="user.new_message != 0" :style="{display: user_msg_notification}" :id="user.id" class=" old badge-danger badge"> {{user.new_message}}  user model </span>
    ...
    export default {
        ...
        methods: {
            ...
            new_message_there: function(value){
                ...
                $('#new_'+value.sender_id).css('display' , 'block').html(value.total_unread_messages + ' pusher');
            },
